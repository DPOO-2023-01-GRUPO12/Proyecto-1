...
public class PanelRegistroReservaHuesped extends JPanel implements ActionListener
{
    ...
    private VentanaHuesped frame;

    public PanelRegistroReservaHuesped(VentanaHuesped ventanaHuesped) {
        this.frame = ventanaHuesped;
